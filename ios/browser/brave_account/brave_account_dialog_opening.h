...
#ifndef BRAVE_IOS_BROWSER_BRAVE_ACCOUNT_BRAVE_ACCOUNT_DIALOG_OPENING_H_
#define BRAVE_IOS_BROWSER_BRAVE_ACCOUNT_BRAVE_ACCOUNT_DIALOG_OPENING_H_
...
// the WebUI can ask for the authentication flows to be opened over them.
// `BraveAccountUIIOS` finds it by walking up from the WebState's view.
OBJC_EXPORT
@protocol BraveAccountDialogOpening <NSObject>
...
#endif  // BRAVE_IOS_BROWSER_BRAVE_ACCOUNT_BRAVE_ACCOUNT_DIALOG_OPENING_H_
