...
public class BraveAccountCustomTabActivity extends CustomTabActivity {
    ...
    private static void openBraveAccountWebUI(
            Activity activity, String url, @Nullable @DialogMode.EnumType Integer dialogMode) {
    ...
    public static void openBraveAccountSettings(Activity activity) {
        openBraveAccountWebUI(activity, "brave://account/settings", null);
    }
    ...
    public static void openBraveAccountDialog(
        ...
        openBraveAccountWebUI(activity, uri.build().toString(), dialogMode);
    }
}
